...
import { AlertTriangle, Mail as MailIcon } from 'lucide-react';
          ...
          {isBanned ? (
            <Card className="border-destructive shadow-xl">
              <CardContent className="pt-8 pb-8 text-center space-y-4">
                ...
                <h2 className="text-xl font-display font-bold text-destructive">Account Deactivated</h2>
                <p className="text-sm text-muted-foreground">
                  Your account has been deactivated by an administrator.
                  You cannot access PeerAxis at this time.
                </p>
                <div className="bg-muted rounded-lg p-4 text-left space-y-2">
                  <p className="text-sm font-semibold">Contact Administrator:</p>
                  <a
                    href="mailto:admin@peeraxis.edu"
                    className="flex items-center gap-2 text-sm text-primary hover:underline"
                  >
                    <MailIcon className="w-4 h-4" />
                    admin@peeraxis.edu
                  </a>
                  <p className="text-xs text-muted-foreground">Include your name and registered email in your message.</p>
                </div>
                <Button variant="outline" className="w-full" onClick={() => setIsBanned(false)}>
                  ← Back to Login
                </Button>
              </CardContent>
            </Card>
